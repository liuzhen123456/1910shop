...
<form action="{{url('admin/update/'.$res->user_id)}}" method="post" class="form-horizontal" role="form" >
@csrf
	<div class="form-group">
		<label for="firstname" class="col-sm-2 control-label">用户名称</label>
		<div class="col-sm-8">
			<input type="text" class="form-control"value="{{$res->user_name}}" name="user_name" id="firstname" 
				   placeholder="请输入用户名称">
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" name="user_tel"value="{{$res->user_tel}}" id="firstname" 
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" name="user_email"value="{{$res->user_email}}" id="firstname" 
				   placeholder="请输入用户邮箱">
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
			<input type="password" class="form-control" name="user_pwd"value="{{$res->user_pwd}}" id="firstname" 
				   placeholder="请输入用户密码">
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
			<input type="password" class="form-control" name="user_pwdd"value="{{$res->user_pwdd}}" id="firstname" 
				   placeholder="请再次输入密码">
