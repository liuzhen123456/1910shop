...
<form action="{{url('friendship/update/'.$res->frie_id)}}" method="post" class="form-horizontal" role="form"enctype="multipart/form-data"  >
@csrf
	<div class="form-group">
		<label for="firstname" class="col-sm-2 control-label">网址名称</label>
		<div class="col-sm-8">
			<input type="text" class="form-control" name="frie_name"value="{{$res->frie_name}}" id="firstname" 
				   placeholder="请输入网址名称">
  ...
  <div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" name="frie_url"value="{{$res->frie_url}}" id="firstname" 
				   placeholder="请输入网址名称">
  ...
  <div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" name="frie_names" value="{{$res->frie_names}}"id="firstname" 
  ...
  <div class="form-group">
		...
		<div class="col-sm-8">
			<textarea type="text" class="form-control" name="frie_desc" id="lastname" 
				   placeholder="请输入网址描述">{{$res->frie_desc}}</textarea>
  ...
  <div class="form-group">
		...
		<div class="col-sm-8">
		<input type="radio" class="form-control" name="is_show" value="logo"{{$res->is_show=="logo"?"checked":""}}>logo
        <input type="radio" class="form-control" name="is_show" value="文享"{{$res->isshow=="文享"?"checked":""}}>文享
		</div>
	</div>
	<div class="form-group">
